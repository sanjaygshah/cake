...
db.collection("cake").get().then((querySnapshot) => {
    querySnapshot.forEach((doc) => {
        console.log(`${doc.id} => ${doc.data()}`);
            ...
            */
pid=doc.id
            newNode.innerHTML ='<div class="panel panel-primary"><img src="'+a.imgurl+'"  width="90%" height="150px" ><br>'+a.summery+'-'+ a.remark+'-'+a.wt+' <strong>Rs.'+a.price+'</strong> <br> <button class="btn btn-danger my-cart-btn" data-id="'+pid+'" data-name="'+a.summery+'" data-summary="'+a.remark+'" data-price="'+a.price+'" data-quantity="1" data-image="'+a.imgurl+'">Add to Cart</button></div>';
